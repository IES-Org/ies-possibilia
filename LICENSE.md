...
All rights, including intellectual property rights in this code and associated materials, are owned by the **Crown**.
...
- View, use, and modify the code as required to fulfil your responsibilities under the IES Steering Group.
...
All actions will be escalated to the IES Steering Group for appropriate handling.
